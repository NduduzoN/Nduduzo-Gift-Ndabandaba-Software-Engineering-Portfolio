export const projects = [
  ...
  },
  {
    ...
    visit: ' https://github.com/NduduzoN/Nduduzo-Gift-Ndabandaba-Software-Engineering-Portfolio',
    id: 0,
  }
];

export const TimeLineData = [
  { year: 2016, text: 'Learnt C++ OOP', },
  { year: 2017, text: 'Learnt sql and linux ubuntu', },
  { year: 2019, text: 'Tought myself javascript ES6', },
  { year: 2020, text: 'Did my in-service trainning PHP MVC and Android(Java)', },
  { year: 2021, text: 'Graduated from Tshwane Univerity Of Technology', },
];