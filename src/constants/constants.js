export const projects = [
  ...
  },
  {
    ...
    description: "Created client side application that connects to the Tax Calculator API I created to calculate a persons tax according to their postal code",
    image: '/images/taxCalcPic.png',
    tags: ['MVC pattern',"C#", 'CSS','Bootstrap','JSON', 'HTML'],
    source: 'https://github.com/NduduzoN/TaxCalculator.git',
